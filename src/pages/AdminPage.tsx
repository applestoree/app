  ...
  return (
    <main className="min-h-full bg-gray-50 flex flex-col">
      <div className="mx-auto w-full max-w-[500px] flex-1 pb-8 p-4">
        ...
        {view === 'dashboard' && <section className="mt-5">
          ...
          <div className="mt-4 rounded-2xl border border-gray-200 bg-white p-4"><h2 className="font-semibold">Overview</h2><p className="mt-2 text-sm text-gray-500">Manage products, orders, users and reviews from the admin views.</p></div>
        </section>}

        {view === 'products' && <section className="mt-5 space-y-3">
      ...
      <div className="mx-auto w-full max-w-[500px]">
        <AdminBottomNav activeView={view} onViewChange={setView} />
      </div>
    </main>
  );
}
