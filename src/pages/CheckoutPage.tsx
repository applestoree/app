...
export const CheckoutPage: React.FC = () => {
  ...
  const handleStateChange = (newState: string) => setAddress(prev => ({ ...prev, state: newState, city: '', postcode: '' }));
  const handleCityChange = (newCity: string) => setAddress(prev => ({ ...prev, city: newCity, postcode: '' }));
